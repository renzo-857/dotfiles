...
alias lupdate='sudo apt-get update -y && apt list --upgradable'
alias lupgrade='sudo apt-get update -y && sudo apt-get dist-upgrade -y && sudo flatpak update'
alias lscan='systemctl list-units --state=failed && sudo debsums -s'
